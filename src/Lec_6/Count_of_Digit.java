...
public class Count_of_Digit {
	...
	public static int Count(int n) {
		//count kaise karte the ? 3467 ko by 10 karenge toh count 1 and number 346 
//		then 2nd time  toh count 2 and number 34. Then next time by 10 toh number 3 and count 3. Then again by 10 toh number 0 and count 4.
